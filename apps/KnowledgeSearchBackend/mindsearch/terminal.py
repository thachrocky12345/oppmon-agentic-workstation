...
from mindsearch.agent.bing_brower import ActionExecutor, CustomBingBrowser, CustomBingSearch
...
agent = MindSearchAgent(
    ...
    searcher_cfg=dict(
        ...
        plugin_executor=ActionExecutor(
            CustomBingBrowser(api_key="f5413713254e4ef88589cec9829991b0",searcher_type='BingBrowser', topk=6)),
        protocol=MindSearchProtocol(
