...
from ..schema import ActionReturn, ActionValidCode
from ..actions.base_action import BaseAction
from ..actions.builtin_actions import FinishAction, InvalidAction, NoAction
...
class ActionExecutor:
    ...
    def get_actions_info(self) -> List[Dict]:
        ...
        for action_name, action in self.actions.items():
            ...
            logging.debug(f"Action: {action_name} + {action}")
        return actions
