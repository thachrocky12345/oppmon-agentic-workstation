...
from ..utils.util import filter_suffix
...
class GPTAPI(BaseAPIModel):
    ...
    def generate_request_data(self,
        ...
        if model_type.lower().startswith('gpt'):
            # Remove parameters not supported by OpenAI GPT models
            gen_params.pop('top_k', None)  # Silently remove top_k without warning
