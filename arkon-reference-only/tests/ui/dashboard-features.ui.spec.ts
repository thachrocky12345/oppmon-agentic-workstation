...
test.describe("Dashboard Features UI", () => {
  ...
  test("dashboard renders health gauge @regression", async ({ page }) => {
  ...
  test("dashboard renders status summary text @regression", async ({ page }) => {
    await page.goto(`${MC_URL}/`);
    await page.waitForLoadState("domcontentloaded");
  ...
  test("dashboard stat cards have tooltips @regression", async ({ page }) => {
    await page.goto(`${MC_URL}/`);
    await page.waitForLoadState("domcontentloaded");
  ...
  test("no console errors on dashboard @regression", async ({ page }) => {
    const errors: string[] = [];
