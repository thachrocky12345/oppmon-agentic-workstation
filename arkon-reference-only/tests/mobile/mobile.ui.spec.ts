...
test.describe("Mobile — Hamburger Menu", () => {
  ...
  test("hamburger button is visible on mobile @regression @mobile", async ({ page }) => {
    await page.goto(`${MC_URL}/`);
    const hamburger = page.locator('[aria-label="Open sidebar"]');
    await expect(hamburger).toBeVisible();
  });

  test("desktop sidebar is hidden on mobile @regression @mobile", async ({ page }) => {
    await page.goto(`${MC_URL}/`);
  ...
  test("hamburger opens mobile sidebar @regression @mobile", async ({ page }) => {
    await page.goto(`${MC_URL}/`);
    const hamburger = page.locator('[aria-label="Open sidebar"]');
  ...
  test("Escape key closes mobile sidebar @regression @mobile", async ({ page }) => {
    await page.goto(`${MC_URL}/`);
  ...
  test("nav links visible inside mobile sidebar @regression @mobile", async ({ page }) => {
    await page.goto(`${MC_URL}/`);
    await page.locator('[aria-label="Open sidebar"]').click();
